...
pheatmap(t(dff), color = Colors, show_rownames = 4, show_colnames = 4, display_numbers =T, number_format = "%.2f",fontsize_number = 5, fontsize_row = 7, fontsize_col = 7, cellwidth = 14, cellheight = 9.5)
